...
public class ConsoleDecompiler implements IBytecodeProvider, IResultSaver {
	...
	public void createArchive(String path, String archiveName, Manifest manifest) {
		...
		try {
			...
			@SuppressWarnings("IOResourceOpenedButNotSafelyClosed") ZipOutputStream zipStream = manifest != null ? new JarOutputStream(fileStream, manifest) : new ZipOutputStream(fileStream);
