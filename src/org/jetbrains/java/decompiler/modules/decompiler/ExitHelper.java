...
public class ExitHelper {
	...
	private static Statement addSharedInitializerReturn(RootStatement root) {
		...
		ExitExprent retexpr = new ExitExprent(ExitExprent.EXIT_RETURN, null, ((MethodDescriptor) DecompilerContext.getProperty(DecompilerContext.CURRENT_METHOD_DESCRIPTOR)).ret, null);
